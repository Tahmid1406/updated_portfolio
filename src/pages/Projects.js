  ...
  const projectsData = [
    {
      ...
      github: "https://github.com/Tahmid1406/MS-thesis", // your repo
      report: "./pdf/ms-thesis.pdf", // optional if you want to link your paper/report
    ...
    },
    {
      ...
      github: "https://github.com/Tahmid1406/LLMchatBot", // update if you have a repo
      report: "./pdf/chatbot.pdf", // optional, remove if not available
    ...
    },
    {
      ...
      github: "", // leave empty if code is not public
      report: "./pdf/blockchain_ml.pdf", // optional, if you want to link compiled paper/PDF
